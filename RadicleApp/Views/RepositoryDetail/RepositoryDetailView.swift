            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                if selectedTab == .files {
                    VStack(alignment: .leading, spacing: 10) {
                        NavigationLink(destination: FileListView(rid: repository.id, sha: latestCommitSHA ?? "unknown", path: nil)) {
                            Text("Browse")
...
//                    // 📂 FILES TAB CONTENT
//                    VStack(alignment: .leading, spacing: 10) {
//                        NavigationLink(destination: FileListView(rid: repository.id, sha: selectedBranch)) {
//                            Text("Browse")
//                                .frame(maxWidth: .infinity)
//                                .padding()
//                                .background(Color.gray.opacity(0.2))
